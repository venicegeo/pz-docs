...
In this example, the job will be executed only when our "US data found" event occurs with the specific problem being that a US bounding box has been found with a severity of 4.
...
----
{
    ...
    "trigger_id": "987d6",
    "event_id": "53dac",
    "job_id": "1da28b90-cc23-85bf-f28c-a215980bc9e4"
}
----
...
NOTE: the `?trigger=id` and `?after=date` query params will soon be provided to make this polling process somewhat more palatable.
